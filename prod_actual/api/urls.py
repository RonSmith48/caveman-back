...
urlpatterns = [
    ...
    path('bdcf/drill/', bdcf.DesignedDrivesView.as_view(), name='bdcf-drill'),
    path('bdcf/to-drill/<str:lvl_od>/',
         bdcf.DesignedRingsListView.as_view(), name='bdcf-drill'),
    path('bdcf/drilled/<str:lvl_od>/',
         bdcf.DrilledRingsListView.as_view(), name='bdcf-drill'),
    path('bdcf/charge/', bdcf.DrilledRingsView.as_view(), name='bdcf-charge'),
    path('bdcf/fire/', bdcf.ChargedRingsView.as_view(), name='bdcf-fire'),
